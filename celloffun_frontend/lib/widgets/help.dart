      ...
      body: SelectionArea(
        child: Text.rich(TextSpan(
            ...
            children: [
              ...
              const TextSpan(text: '• Красные клетки – клетки противника.\n'),
              const TextSpan(
                  text:
...
Если некоторый участок поля (3 на 3) в точности совпадет с шаблоном, то центральная клетка этого участка изменит состояние на указанное:'''),
              ...
              const TextSpan(
                  text:
                      '''Согласно этому правилу, белая клетка станет синей, если снизу от нее уже есть синяя клетка. Это приведет к появлению вертикальной линии синих клеток (подумайте, почему).\n'''),
